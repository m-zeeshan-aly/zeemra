...
export default function TopSellingShopPage() {
  ...
  return (
    <div className="shop-page shop-page--dark">
      {/* Header */}
      <div className="shop-header">
        <Link href="/" className="shop-back">← Back to Home</Link>
        <h1 className="shop-title">Top Selling</h1>
        <p className="shop-subtitle">The pieces our customers keep coming back for — proven by thousands of orders</p>
